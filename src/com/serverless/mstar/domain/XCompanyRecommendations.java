...
@JsonPropertyOrder({ "Outcome", "Message", "Identity", "Delay", "Company", "RecommendationSummarySet" })
public class XCompanyRecommendations {
	...
	public String toString() {
		return new ToStringBuilder(this).append("outcome", outcome).append("message", message)
				.append("identity", identity).append("delay", delay).append("company", company)
				.append("recommendationSummarySet", recommendationSummarySet)
