...
public class XigniteService {
	...
	String token = "AE4A02E0271A4E77B78B314AEE9A132D";

	public ExchangeResult getExchanges() {
		return this.restTemplate.getForObject(
				"https://factsetestimates.xignite.com/xFactSetEstimates.json/ListExchanges?&_token="+token,
	...
	public String getGlobalNewsListSectorsAsStr() {
		return this.restTemplate.getForObject(
				"https://globalnews.xignite.com/xGlobalNews.json/ListSectors?&_token="+token,
				String.class);
	...
	public String getGlobalNewsTodaysMarketHeadlinesAsStr() {
		return this.restTemplate.getForObject(
				"https://globalnews.xignite.com/xGlobalNews.json/GetTodaysMarketHeadlines?&_token="+token,
				String.class);
	...
	public String getGlobalNewsTodaysSecurityHeadlinesAsStr(String securityName) {
		return this.restTemplate.getForObject(
				"https://globalnews.xignite.com/xGlobalNews.json/GetTodaysSecurityHeadlines?IdentifierType=Symbol&Identifier="+securityName+"&_token="+token,
				String.class);
	}
	...
	public String getGlobalNewsTopSecurityHeadlinesAsStr(String securityName) {
		return this.restTemplate.getForObject(
				"https://globalnews.xignite.com/xGlobalNews.json/GetTopSecurityHeadlines?IdentifierType=Symbol&Identifier="+securityName+"&Count=3&_token="+token,
				String.class);
	}
	
	public String getTopMoversAsStr(String exchangename) {
		return this.restTemplate.getForObject(
				"https://globalquotes.xignite.com/v3/xGlobalQuotes.json/GetTopMarketMovers?MarketMoverType=PercentGainers&NumberOfMarketMovers=3&Exchanges="+exchangename+"&_token="+token,
				String.class);
	}
	
	public String getEstimatesAsStr(String companyList) {
		return this.restTemplate.getForObject(
				"https://factsetestimates.xignite.com/xFactSetEstimates.json/GetLatestEstimates?IdentifierType=Symbol&Identifiers="+companyList+"&EstimateTypes=EPS,Sales&ReportType=Annual&UpdatedSince=&_token="+token,
				String.class);
	}

	public String getRecommendationsAsStr(String companyList) {
		return this.restTemplate.getForObject(
				"https://factsetestimates.xignite.com/xFactSetEstimates.json/GetLatestRecommendationSummaries?IdentifierType=Symbol&Identifiers="+companyList+"&UpdatedSince=&_token="+token,
				String.class);
	}
	
	public String getGlobalNewsTopMarketHeadlinesAsStr() {
		return this.restTemplate.getForObject(
				"https://globalnews.xignite.com/xGlobalNews.json/GetTopMarketHeadlines?Count=10&_token="+token,
				String.class);
	}
