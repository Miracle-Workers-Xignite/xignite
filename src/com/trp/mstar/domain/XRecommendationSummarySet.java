...
"NumberOfOverweightRecommendations",
"NumberOfHoldRecommendations",
"NumberOfUnderweightRecommendations",
"NumberOfSellRecommendations",
"TotalNumberOfRecommendations",
"NumberOfUnreportedRecommendations",
"LastUpdated"
})
...
return new ToStringBuilder(this).append("date", date).append("currency", currency).append("targetPrice", targetPrice).append("recommendation", recommendation).append("recommendationScore", recommendationScore).append("numberOfBuyRecommendations", numberOfBuyRecommendations).append("numberOfOverweightRecommendations", numberOfOverweightRecommendations).append("numberOfHoldRecommendations", numberOfHoldRecommendations).append("numberOfUnderweightRecommendations", numberOfUnderweightRecommendations).append("numberOfSellRecommendations", numberOfSellRecommendations).append("totalNumberOfRecommendations", totalNumberOfRecommendations).append("numberOfUnreportedRecommendations", numberOfUnreportedRecommendations).append("lastUpdated", lastUpdated).append("additionalProperties", additionalProperties).toString();
}
