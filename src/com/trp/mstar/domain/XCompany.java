...
public class XCompany {
	...
	return new ToStringBuilder(this).append("name", name).append("symbol", symbol).append("cIK", cIK).append("cUSIP", cUSIP).append("sEDOL", sEDOL).append("iSIN", iSIN).append("factSetSecurityID", factSetSecurityID).append("factSetIssuerID", factSetIssuerID).append("valoren", valoren).append("market", market).append("marketIdentificationCode", marketIdentificationCode).append("primaryMarket", primaryMarket).append("primaryMarketIdentificationCode", primaryMarketIdentificationCode).append("sector", sector).append("industry", industry).append("statementTemplate", statementTemplate).append("additionalProperties", additionalProperties).toString();
	}
